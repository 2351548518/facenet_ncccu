...
from code.nets.inception_resnetv1 import InceptionResnetV1
from code.nets.mobilenet import MobileNetV1
...
class mobilenet(nn.Module):
    def __init__(self, pretrained):
        ...
        if pretrained:
            state_dict = load_state_dict_from_url("https://github.com/bubbliiiing/facenet-pytorch/releases/download/v1.0/backbone_weights_of_mobilenetv1.pth", model_dir="model",
                                                progress=True)
...
class inception_resnet(nn.Module):
    def __init__(self, pretrained):
        ...
        if pretrained:
            state_dict = load_state_dict_from_url("https://github.com/bubbliiiing/facenet-pytorch/releases/download/v1.0/backbone_weights_of_inception_resnetv1.pth", model_dir="model",
                                                progress=True)
            self.model.load_state_dict(state_dict)
