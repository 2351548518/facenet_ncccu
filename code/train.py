...
from code.nets.facenet import Facenet
from code.nets.facenet_training import (get_lr_scheduler, set_optimizer_lr,
                                        triplet_loss)
from code.utils.callback import LossHistory
from code.utils.dataloader import FacenetDataset, LFWDataset, dataset_collate
from code.utils.utils import get_num_classes, show_config
from code.utils.utils_fit import fit_one_epoch
...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------#
    annotation_path = "../init_data/cls_train.txt"
    # --------------------------------------------------------#
    ...
    # ------------------------------------------------------------------#
    # lfw_dir_path    = "lfw"
    # lfw_pairs_path  = "model/lfw_pair.txt"
    lfw_dir_path = "../init_data/mylfw"
    lfw_pairs_path = "../init_data/my_lfw_pair.txt"
